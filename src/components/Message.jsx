  ...
  return (
    ...
    {ownMessage ? (
        <div className="flex justify-end my-2 gap-2">
            <p className="max-w-[300px] bg-greenM1 text-grayM p-2 rounded-lg" id="message-text">{message.text}</p>
        ...
        <div className="flex justify-start my-2 gap-2">
            ...
            <p className="max-w-[300px] bg-grayM p-2 rounded-lg" id="message-text">{message.text}</p>
        </div>
    )}
